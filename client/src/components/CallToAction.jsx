...
const CallToAction = () => {
  return (
        <div className="max-w-5xl mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30 mt-28">
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">  
                ...
                <Link to='/app?state=register' className="bg-gradient-to-r from-green-600 to-blue-500 text-white text-sm px-5 py-2.5 rounded-xl font-medium mt-4 hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer"> 
                    Get Started Today
                </Link>
            </div>
        </div>
