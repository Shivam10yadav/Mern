...
const Features = () => {
  ...
  return (
   ...
   <div className="flex items-center justify-center gap-2 text-slate-600  rounded-full px-4 py-2">
            <div className="size-2.5 bg-green-600 rounded-full"></div>
            <span>Simple Process </span>
        </div>
        <Title title="Build Your Resume" description="Build smarter not harder. AI transforms your detail into a clean,professional resume that gets noticed"/>
 
            <div id="features" className="flex flex-col md:flex-row items-center justify-center xl:-mt-10">
