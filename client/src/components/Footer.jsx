...
const Footer = () => {
  return (
        <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full mt-30 bg-green-100">
            <div  id="cta"className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">
